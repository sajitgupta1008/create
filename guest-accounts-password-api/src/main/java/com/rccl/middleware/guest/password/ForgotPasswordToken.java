...
public class ForgotPasswordToken {
    ...
    @Size(min = 5, max = 256, message = "The email can only have up to 100 characters.", groups = NewUserChecks.class)
    ...
    @Pattern(regexp = "[0-9]", message = "A Shopper ID must be numeric.", groups = WebShopperChecks.class)
    String webShopperId;
