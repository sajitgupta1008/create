...
public class ResetPasswordEmail {
    ...
    public void send(ForgotPassword fp, String email, String firstName, String resetPasswordUrl, String languageCode) {
        LOGGER.info("#send - Attempting to send the email to: " + email);
        
        this.getEmailContent(fp, firstName, resetPasswordUrl, languageCode)
    ...
    private CompletionStage<HtmlEmailTemplate> getEmailContent(ForgotPassword fp, String firstName,
                                                               String resetPasswordUrl, String languageCode) {
